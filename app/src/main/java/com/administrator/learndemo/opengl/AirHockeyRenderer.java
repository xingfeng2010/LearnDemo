...
import com.administrator.learndemo.opengl.objects.Mallet;
import com.administrator.learndemo.opengl.objects.Puck;
import com.administrator.learndemo.opengl.objects.Table;
import com.administrator.learndemo.opengl.programs.ColorShaderProgram;
import com.administrator.learndemo.opengl.programs.TextureShaderProgram;
import com.administrator.learndemo.opengl.util.Geometry;
import com.administrator.learndemo.opengl.util.Geometry.*;
...
public class AirHockeyRenderer implements GLSurfaceView.Renderer {
    ...
    public void handleTouchPress(float normalizedX, float normalizedY) {
        ...
        malletPressed = judgeMalletPressed(ray, blueMalletPosition);
        redMalletPressed = judgeMalletPressed(ray, redMalletPosition);
    }

    private boolean judgeMalletPressed(Ray ray, Point malletPosition) {
        ...
        // true.
        return Geometry.intersects(malletBoundingSphere, ray);
    }
