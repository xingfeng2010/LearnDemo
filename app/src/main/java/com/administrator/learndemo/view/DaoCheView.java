 ...
 */
public class DaoCheView extends View {
    ...
    public DaoCheView(Context context) {
        super(context);
        init(null, 0);
    }

    public DaoCheView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public DaoCheView(Context context, AttributeSet attrs, int defStyle) {
